...
class GridTiler(Tiler):
    ...
    def _tiles_generator(
        ...
        dzg = DeepZoomGenerator(slide._wsi, tile_size=224, overlap=0, limit_bounds=False)

        if slide.level_magnification_factor() == '20.0X':
            level_dimensions = dzg.level_count - 3
            level_tiles = dzg.level_tiles[level_dimensions]
        if slide.level_magnification_factor() == '40.0X':
            level_dimensions = dzg.level_count - 4
            level_tiles = dzg.level_tiles[level_dimensions]
